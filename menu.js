const permanentMarkers = {
    weed: [
        { x: 2355, y: 3780, label: "Weed Location #1", area: "Missing Location", description: "Placeholder description", images: [] },
        ...
        { x: 6011, y: 3688, label: "Weed Location #5", area: "Missing Location", description: "Placeholder description", images: [] },
        { x: 6481, y: 2566, label: "Weed Location #6", area: "Missing Location", description: "Placeholder description", images: [] },
    ],
    meth: [
        { x: 5707, y: 4998, label: "Meth Table #1", area: "Missing Location", description: "Placeholder description", images: [] },
    ...
    washing: [
        ...
        { x: 4770, y: 3162, label: "Washing Machine #4", area: "Missing Location", description: "Placeholder description", images: [] },
    ]
};
